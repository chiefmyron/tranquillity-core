...
class CreateUserService implements ApplicationService
{
    ...
    private CreateUserDataTransformer $dataTransformer;

    public function __construct(UserRepository $repository, HashingService $hashingService, CreateUserDataTransformer $dataTransformer)
    {
