...
class UpdatePersonService implements ApplicationService
{
    ...
    private UpdatePersonDataTransformer $dataTransformer;

    public function __construct(PersonRepository $repository, UpdatePersonDataTransformer $dataTransformer)
    {
